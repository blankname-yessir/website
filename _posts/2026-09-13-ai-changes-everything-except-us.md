...
Human anatomy is suited for building fires, picking berries, and chasing down wild animals with the boys. Machines can be built for the sole purpose of controlling other machines. Is that really a big take?
...
And every single time we fill the gap with something else.

Go back fifty years and look at a normal day. By any reasonable measure we should be working two-hour days and following our bliss. Instead we're busier and more stressed. The time we saved got spent immediately on things we didn't know we 'needed' until they existed.

Does our desire for more make us broken?
